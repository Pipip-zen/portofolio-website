...
const projects = [
    ...
    {
        id: 3,
        title: 'Craftlab Simulation VR App',
        desc: 'VR game application for computer assembly simulation.',
        type: 'Game',
        tags: ['Three.js', 'Babylon.js', 'WebGL'],
        accent: '#EC4899',
        cols: 'col-span-2',
        screen: '#2a0d1e',
        mockupType: 'laptop',
        image: '/portofolio/craftlab.png',
        demoUrl: 'https://daniswara99.met.student.pens.ac.id/vr/index.html',
        githubUrl: 'https://github.com/arguspermono/VR_RAKIT-PC',
    },
    {
        id: 4,
        title: 'Eye Focus Timer Tracking',
        desc: 'Eye focus timer tracking web app.',
        type: 'Others',
        tags: ['Python', 'OpenCV', 'Mediapipe', 'Streamlit'],
        accent: '#EC4899',
        cols: 'col-span-1',
        screen: '#2a0d1e',
        mockupType: 'laptop',
        image: '/portofolio/eye-tracking.png',
        githubUrl: 'https://pipip-zen.github.io/eye-tracking-doc/',
        githubLabel: 'Documentation',
    },
]
